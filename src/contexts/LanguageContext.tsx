...
const translations = {
  en: {
    ...
    'extraction_error': 'Error extracting job details, make sure is the public view',
    ...
    'invalid_linkedin_url': 'Invalid LinkedIn URL, make sure is the public view, make sure is the public view',
    'please_enter_valid_linkedin': 'Please enter a valid LinkedIn job URL',
    'linkedin_url_required': 'LinkedIn job URL required',
    'no_job_desc_found': 'No job description found in the LinkedIn post, make sure is the public view',
    'use_text_input': 'Use text description instead',
    'use_linkedin_url': 'Use linkedin link instead',
  ...
  es: {
    ...
    'extraction_error': 'Error al extraer detalles del trabajo, asegurate que sea la url pública',
